        ...
        .then(results => {
          ...
          const responseData = {
            topNumber: [
              ...
              {
                title: '总计',
                number: Math.floor(totalCount / 1000),
                unit: '千',
              },
              {
                title: '型号',
            ...
            bar: {
              "OK": uniqueRows
                ...
                .reduce((acc, row) => {
                  const date = row.datetime ? row.datetime.split(' ')[0] : today;
              ...
              all: uniqueRows
                ...
                .reduce((acc, row) => {
                  ...
                  if (existing) {
                    ...
                    acc.push({ name: (defect || '未知缺陷').substring(0, 10), value: 1 });
                  }
                  return acc;
                }, []),
              week: uniqueRows
          ...
          res.json({ code: 200, data: responseData, error: '' });
        })
        .catch(error => {
